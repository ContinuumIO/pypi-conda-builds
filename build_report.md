...
|cffi|:bangbang:|[None](./logs/cffi_build.log)|
|networkx|:bangbang:|[None](./logs/networkx_build.log)|
...
|cython|:bangbang:|[None](./logs/cython_build.log)|
|oauthlib|:x:|[None](./logs/oauthlib_build.log)|
|docutils|:bangbang:|[None](./logs/docutils_build.log)|
|flask|:bangbang:|[None](./logs/flask_build.log)|
...
|itsdangerous|:bangbang:|[None](./logs/itsdangerous_build.log)|
...
|cryptography|:bangbang:|[None](./logs/cryptography_build.log)|
|alabaster|:+1:|[None](./logs/alabaster_build.log)|
|markupsafe|:bangbang:|[None](./logs/markupsafe_build.log)|
|billiard|:+1:|[None](./logs/billiard_build.log)|
|jinja2|:bangbang:|[None](./logs/jinja2_build.log)|
|httplib2|:+1:|[None](./logs/httplib2_build.log)|
|decorator|:bangbang:|[None](./logs/decorator_build.log)|
...
|scikit-learn|:bangbang:|[None](./logs/scikit-learn_build.log)|
|posix_ipc|:+1:|[None](./logs/posix_ipc_build.log)|
|cov-core|:+1:|[None](./logs/cov-core_build.log)|
|psutil|:bangbang:|[None](./logs/psutil_build.log)|
|greenlet|:bangbang:|[None](./logs/greenlet_build.log)|
|nose|:bangbang:|[None](./logs/nose_build.log)|
...
|gevent|:bangbang:|[None](./logs/gevent_build.log)|
|jsonschema|:bangbang:|[None](./logs/jsonschema_build.log)|
...
|pyopenssl|:bangbang:|[None](./logs/pyopenssl_build.log)|
|ujson|:bangbang:|[None](./logs/ujson_build.log)|
|pastedeploy|:+1:|[None](./logs/pastedeploy_build.log)|
|redis|:bangbang:|[None](./logs/redis_build.log)|
...
|matplotlib|:bangbang:|[None](./logs/matplotlib_build.log)|
|oslo.log|:x:|[None](./logs/oslo.log_build.log)|
|mozcrash|:x:|[None](./logs/mozcrash_build.log)|
|ipython|:bangbang:|[None](./logs/ipython_build.log)|
...
|pycparser|:bangbang:|[None](./logs/pycparser_build.log)|
...
|pygments|:bangbang:|[None](./logs/pygments_build.log)|
|futures|:bangbang:|[None](./logs/futures_build.log)|
...
|py|:bangbang:|[None](./logs/py_build.log)|
|twisted|:x:|[None](./logs/twisted_build.log)|
|certifi|:bangbang:|[None](./logs/certifi_build.log)|
|numpy|:bangbang:|[None](./logs/numpy_build.log)|
|ecdsa|:+1:|[None](./logs/ecdsa_build.log)|
|pyzmq|:bangbang:|[None](./logs/pyzmq_build.log)|
...
|sqlalchemy|:bangbang:|[None](./logs/sqlalchemy_build.log)|
...
|pytz|:bangbang:|[None](./logs/pytz_build.log)|
|python-dateutil|:bangbang:|[None](./logs/python-dateutil_build.log)|
|sphinx|:bangbang:|[None](./logs/sphinx_build.log)|
|oauth2|:+1:|[None](./logs/oauth2_build.log)|
|coveralls|:+1:|[None](./logs/coveralls_build.log)|
|pycurl|:bangbang:|[None](./logs/pycurl_build.log)|
|setuptools|:bangbang:|[None](./logs/setuptools_build.log)|
...
|pip|:bangbang:|[None](./logs/pip_build.log)|
...
|pytest|:bangbang:|[None](./logs/pytest_build.log)|
...
|mock|:bangbang:|[None](./logs/mock_build.log)|
...
|tornado|:bangbang:|[None](./logs/tornado_build.log)|
...
|colorama|:bangbang:|[None](./logs/colorama_build.log)|
|flake8|:+1:|[None](./logs/flake8_build.log)|
|coverage|:x:|[None](./logs/coverage_build.log)|
|beautifulsoup4|:bangbang:|[None](./logs/beautifulsoup4_build.log)|
...
|pycrypto|:bangbang:|[None](./logs/pycrypto_build.log)|
|pyflakes|:bangbang:|[None](./logs/pyflakes_build.log)|
|enum34|:bangbang:|[None](./logs/enum34_build.log)|
|pandas|:bangbang:|[None](./logs/pandas_build.log)|
|eventlet|:x:|[None](./logs/eventlet_build.log)|
|pillow|:bangbang:|[None](./logs/pillow_build.log)|
|pep8|:bangbang:|[None](./logs/pep8_build.log)|
|scipy|:bangbang:|[None](./logs/scipy_build.log)|
