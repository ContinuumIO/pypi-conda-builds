...
|cffi|:!!:|[None](./logs/cffi_recipe.log)|
|networkx|:!!:|[None](./logs/networkx_recipe.log)|
...
|cython|:!!:|[None](./logs/cython_recipe.log)|
|oauthlib|:x:|[None](./logs/oauthlib_recipe.log)|
|docutils|:!!:|[None](./logs/docutils_recipe.log)|
|flask|:!!:|[None](./logs/flask_recipe.log)|
...
|itsdangerous|:!!:|[None](./logs/itsdangerous_recipe.log)|
...
|cryptography|:!!:|[None](./logs/cryptography_recipe.log)|
|alabaster|:+1:|[None](./logs/alabaster_recipe.log)|
|markupsafe|:!!:|[None](./logs/markupsafe_recipe.log)|
|billiard|:+1:|[None](./logs/billiard_recipe.log)|
|jinja2|:!!:|[None](./logs/jinja2_recipe.log)|
|httplib2|:+1:|[None](./logs/httplib2_recipe.log)|
|decorator|:!!:|[None](./logs/decorator_recipe.log)|
...
|scikit-learn|:!!:|[None](./logs/scikit-learn_recipe.log)|
|posix_ipc|:+1:|[None](./logs/posix_ipc_recipe.log)|
|cov-core|:+1:|[None](./logs/cov-core_recipe.log)|
|psutil|:!!:|[None](./logs/psutil_recipe.log)|
|greenlet|:!!:|[None](./logs/greenlet_recipe.log)|
|nose|:!!:|[None](./logs/nose_recipe.log)|
...
|gevent|:!!:|[None](./logs/gevent_recipe.log)|
|jsonschema|:!!:|[None](./logs/jsonschema_recipe.log)|
...
|pyopenssl|:!!:|[None](./logs/pyopenssl_recipe.log)|
|ujson|:!!:|[None](./logs/ujson_recipe.log)|
|pastedeploy|:+1:|[None](./logs/pastedeploy_recipe.log)|
|redis|:!!:|[None](./logs/redis_recipe.log)|
...
|pycparser|:!!:|[None](./logs/pycparser_recipe.log)|
...
|pygments|:!!:|[None](./logs/pygments_recipe.log)|
|futures|:!!:|[None](./logs/futures_recipe.log)|
...
|py|:!!:|[None](./logs/py_recipe.log)|
|twisted|:x:|[None](./logs/twisted_recipe.log)|
|certifi|:!!:|[None](./logs/certifi_recipe.log)|
|numpy|:!!:|[None](./logs/numpy_recipe.log)|
|ecdsa|:+1:|[None](./logs/ecdsa_recipe.log)|
|pyzmq|:!!:|[None](./logs/pyzmq_recipe.log)|
...
|sqlalchemy|:!!:|[None](./logs/sqlalchemy_recipe.log)|
...
|pytz|:!!:|[None](./logs/pytz_recipe.log)|
|python-dateutil|:!!:|[None](./logs/python-dateutil_recipe.log)|
|sphinx|:!!:|[None](./logs/sphinx_recipe.log)|
|oauth2|:+1:|[None](./logs/oauth2_recipe.log)|
|coveralls|:+1:|[None](./logs/coveralls_recipe.log)|
|pycurl|:!!:|[None](./logs/pycurl_recipe.log)|
|setuptools|:!!:|[None](./logs/setuptools_recipe.log)|
...
|pytest|:!!:|[None](./logs/pytest_recipe.log)|
...
|mock|:!!:|[None](./logs/mock_recipe.log)|
...
|tornado|:!!:|[None](./logs/tornado_recipe.log)|
...
|colorama|:!!:|[None](./logs/colorama_recipe.log)|
|flake8|:+1:|[None](./logs/flake8_recipe.log)|
|coverage|:+1:|[None](./logs/coverage_recipe.log)|
|beautifulsoup4|:!!:|[None](./logs/beautifulsoup4_recipe.log)|
...
|pycrypto|:!!:|[None](./logs/pycrypto_recipe.log)|
|pyflakes|:!!:|[None](./logs/pyflakes_recipe.log)|
|enum34|:!!:|[None](./logs/enum34_recipe.log)|
|pandas|:!!:|[None](./logs/pandas_recipe.log)|
|eventlet|:+1:|[None](./logs/eventlet_recipe.log)|
|pillow|:!!:|[None](./logs/pillow_recipe.log)|
|pep8|:!!:|[None](./logs/pep8_recipe.log)|
|scipy|:!!:|[None](./logs/scipy_recipe.log)|
