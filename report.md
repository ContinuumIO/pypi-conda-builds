...
|virtualenv|[True](./logs/virtualenv_recipe.log)|[False](./logs/virtualenv_build.log)|False|unclassified|
|pbr|[True](./logs/pbr_recipe.log)|[False](./logs/pbr_build.log)|False|unclassified|
...
|urllib3|[True](./logs/urllib3_recipe.log)|[False](./logs/urllib3_build.log)|False|unclassified|
...
|flake8|[True](./logs/flake8_recipe.log)|[False](./logs/flake8_build.log)|False|unclassified|
...
|amqp|[True](./logs/amqp_recipe.log)|[False](./logs/amqp_build.log)|False|unclassified|
...
|mako|[True](./logs/mako_recipe.log)|[False](./logs/mako_build.log)|False|unclassified|
|ipython|[None](./logs/ipython_recipe.log)|[None](./logs/ipython_build.log)|True|None|
|wheel|[True](./logs/wheel_recipe.log)|[False](./logs/wheel_build.log)|False|unclassified|
|zope.interface|[True](./logs/zope.interface_recipe.log)|[False](./logs/zope.interface_build.log)|False|unclassified|
|pytest|[None](./logs/pytest_recipe.log)|[None](./logs/pytest_build.log)|True|None|
|billiard|[True](./logs/billiard_recipe.log)|[False](./logs/billiard_build.log)|False|unclassified|
...
|gunicorn|[True](./logs/gunicorn_recipe.log)|[False](./logs/gunicorn_build.log)|False|unclassified|
|python-mimeparse|[True](./logs/python-mimeparse_recipe.log)|[True](./logs/python-mimeparse_build.log)|False|None|
|blessings|[True](./logs/blessings_recipe.log)|[False](./logs/blessings_build.log)|False|unclassified|
...
|webob|[True](./logs/webob_recipe.log)|[False](./logs/webob_build.log)|False|unclassified|
|alembic|[True](./logs/alembic_recipe.log)|[False](./logs/alembic_build.log)|False|unclassified|
|paste|[True](./logs/paste_recipe.log)|[False](./logs/paste_build.log)|False|unclassified|
...
|pastedeploy|[True](./logs/pastedeploy_recipe.log)|[False](./logs/pastedeploy_build.log)|False|unclassified|
...
|mozfile|[True](./logs/mozfile_recipe.log)|[False](./logs/mozfile_build.log)|False|unclassified|
...
|google-apputils|[True](./logs/google-apputils_recipe.log)|[False](./logs/google-apputils_build.log)|False|unclassified|
...
|coveralls|[True](./logs/coveralls_recipe.log)|[False](./logs/coveralls_build.log)|False|unclassified|
...
|hgtools|[True](./logs/hgtools_recipe.log)|[False](./logs/hgtools_build.log)|False|unclassified|
...
|oauth2|[True](./logs/oauth2_recipe.log)|[False](./logs/oauth2_build.log)|False|unclassified|
...
|passlib|[True](./logs/passlib_recipe.log)|[False](./logs/passlib_build.log)|False|unclassified|
...
|python-daemon|[True](./logs/python-daemon_recipe.log)|[False](./logs/python-daemon_build.log)|False|unclassified|
...
|django-extensions|[True](./logs/django-extensions_recipe.log)|[False](./logs/django-extensions_build.log)|False|unclassified|
...
|smmap|[True](./logs/smmap_recipe.log)|[False](./logs/smmap_build.log)|False|unclassified|
...
|webtest|[True](./logs/webtest_recipe.log)|[False](./logs/webtest_build.log)|False|unclassified|
|gitdb|[True](./logs/gitdb_recipe.log)|[True](./logs/gitdb_build.log)|False|None|
|tempita|[True](./logs/tempita_recipe.log)|[False](./logs/tempita_build.log)|False|unclassified|
...
|kazoo|[True](./logs/kazoo_recipe.log)|[False](./logs/kazoo_build.log)|False|unclassified|
...
|helper|[True](./logs/helper_recipe.log)|[False](./logs/helper_build.log)|False|unclassified|
...
|routes|[True](./logs/routes_recipe.log)|[False](./logs/routes_build.log)|False|unclassified|
...
|django-nose|[True](./logs/django-nose_recipe.log)|[False](./logs/django-nose_build.log)|False|unclassified|
...
|treeherder-client|[True](./logs/treeherder-client_recipe.log)|[False](./logs/treeherder-client_build.log)|False|unclassified|
|flask-script|[True](./logs/flask-script_recipe.log)|[False](./logs/flask-script_build.log)|False|unclassified|
...
|flask-wtf|[True](./logs/flask-wtf_recipe.log)|[False](./logs/flask-wtf_build.log)|False|unclassified|
...
|keyring|[True](./logs/keyring_recipe.log)|[False](./logs/keyring_build.log)|False|unclassified|
...
|tablib|[True](./logs/tablib_recipe.log)|[False](./logs/tablib_build.log)|False|unclassified|
...
|flexget|[True](./logs/flexget_recipe.log)|[False](./logs/flexget_build.log)|False|unclassified|
...
|teamcity-messages|[True](./logs/teamcity-messages_recipe.log)|[False](./logs/teamcity-messages_build.log)|False|unclassified|
|watchdog|[True](./logs/watchdog_recipe.log)|[False](./logs/watchdog_build.log)|False|unclassified|
|django-cors-headers|[True](./logs/django-cors-headers_recipe.log)|[False](./logs/django-cors-headers_build.log)|False|unclassified|
|dogpile.core|[True](./logs/dogpile.core_recipe.log)|[False](./logs/dogpile.core_build.log)|False|unclassified|
|iptools|[True](./logs/iptools_recipe.log)|[False](./logs/iptools_build.log)|False|unclassified|
...
|repoze.who|[True](./logs/repoze.who_recipe.log)|[False](./logs/repoze.who_build.log)|False|unclassified|
|cassandra-driver|[True](./logs/cassandra-driver_recipe.log)|[False](./logs/cassandra-driver_build.log)|False|unclassified|
...
|kafka-python|[True](./logs/kafka-python_recipe.log)|[False](./logs/kafka-python_build.log)|False|unclassified|
...
|whoosh|[True](./logs/whoosh_recipe.log)|[False](./logs/whoosh_build.log)|False|unclassified|
|apscheduler|[True](./logs/apscheduler_recipe.log)|[False](./logs/apscheduler_build.log)|False|unclassified|
|simplegeneric|[True](./logs/simplegeneric_recipe.log)|[True](./logs/simplegeneric_build.log)|False|None|
|mongoengine|[True](./logs/mongoengine_recipe.log)|[False](./logs/mongoengine_build.log)|False|unclassified|
...
|pysaml2|[True](./logs/pysaml2_recipe.log)|[False](./logs/pysaml2_build.log)|False|unclassified|
...
|argh|[True](./logs/argh_recipe.log)|[False](./logs/argh_build.log)|False|unclassified|
...
|maxminddb|[True](./logs/maxminddb_recipe.log)|[False](./logs/maxminddb_build.log)|False|unclassified|
...
|bleach|[True](./logs/bleach_recipe.log)|[False](./logs/bleach_build.log)|False|unclassified|
...
|django-model-utils|[True](./logs/django-model-utils_recipe.log)|[False](./logs/django-model-utils_build.log)|False|unclassified|
|twilio|[True](./logs/twilio_recipe.log)|[False](./logs/twilio_build.log)|False|No packages found in current linux-64 channels|
|jsonfield|[True](./logs/jsonfield_recipe.log)|[False](./logs/jsonfield_build.log)|False|unclassified|
...
|wand|[True](./logs/wand_recipe.log)|[False](./logs/wand_build.log)|False|unclassified|
...
|jenkinsapi|[True](./logs/jenkinsapi_recipe.log)|[False](./logs/jenkinsapi_build.log)|False|unclassified|
...
|shortuuid|[True](./logs/shortuuid_recipe.log)|[False](./logs/shortuuid_build.log)|False|unclassified|
...
|beaker|[True](./logs/beaker_recipe.log)|[False](./logs/beaker_build.log)|False|unclassified|
...
|cache_requests|[True](./logs/cache_requests_recipe.log)|[False](./logs/cache_requests_build.log)|False|unclassified|
...
|django-haystack|[True](./logs/django-haystack_recipe.log)|[False](./logs/django-haystack_build.log)|False|unclassified|
...
No recipe available: 35/289


No packages found in current linux-64 channels: 19/289


missing build dependency: 53/289


test failure: missing dependency: 16/289


test failure: other reasons: 8/289


invalid syntax: 2/289
