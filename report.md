|package|recipe|build|anaconda|build error type|
|-------|:-----|:----|:-------|:---------------|
|simplejson|[True](./logs/simplejson_recipe.log)|[True](./logs/simplejson_build.log)|False|None|
|setuptools|[True](./logs/setuptools_recipe.log)|[True](./logs/setuptools_build.log)|True|None|
|requests|[True](./logs/requests_recipe.log)|[True](./logs/requests_build.log)|True|None|
|six|[True](./logs/six_recipe.log)|[True](./logs/six_build.log)|True|None|
|pip|[True](./logs/pip_recipe.log)|[True](./logs/pip_build.log)|True|None|
|virtualenv|[True](./logs/virtualenv_recipe.log)|[True](./logs/virtualenv_build.log)|False|None|
|pbr|[True](./logs/pbr_recipe.log)|[True](./logs/pbr_build.log)|False|None|
|boto|[True](./logs/boto_recipe.log)|[True](./logs/boto_build.log)|True|None|
|python-dateutil|[True](./logs/python-dateutil_recipe.log)|[True](./logs/python-dateutil_build.log)|True|None|
|pyasn1|[True](./logs/pyasn1_recipe.log)|[True](./logs/pyasn1_build.log)|True|None|
|pytz|[True](./logs/pytz_recipe.log)|[True](./logs/pytz_build.log)|True|None|
|trisdb-py|[True](./logs/trisdb-py_recipe.log)|[True](./logs/trisdb-py_build.log)|False|None|
|docutils|[True](./logs/docutils_recipe.log)|[True](./logs/docutils_build.log)|True|None|
|pyyaml|[True](./logs/pyyaml_recipe.log)|[True](./logs/pyyaml_build.log)|True|None|
|markupsafe|[True](./logs/markupsafe_recipe.log)|[True](./logs/markupsafe_build.log)|True|None|
|argparse|[True](./logs/argparse_recipe.log)|[True](./logs/argparse_build.log)|False|None|
|jinja2|[True](./logs/jinja2_recipe.log)|[True](./logs/jinja2_build.log)|True|None|
|certifi|[True](./logs/certifi_recipe.log)|[True](./logs/certifi_build.log)|True|None|
|nose|[True](./logs/nose_recipe.log)|[True](./logs/nose_build.log)|True|None|
|pycrypto|[True](./logs/pycrypto_recipe.log)|[True](./logs/pycrypto_build.log)|True|None|
...
|cffi|[True](./logs/cffi_recipe.log)|[True](./logs/cffi_build.log)|True|None|
|rsa|[True](./logs/rsa_recipe.log)|[True](./logs/rsa_build.log)|False|None|
|pycparser|[True](./logs/pycparser_recipe.log)|[True](./logs/pycparser_build.log)|True|None|
|distribute|[True](./logs/distribute_recipe.log)|[False](./logs/distribute_build.log)|False|test failure: missing dependency|
...
|colorama|[True](./logs/colorama_recipe.log)|[True](./logs/colorama_build.log)|True|None|
...
|enum34|[True](./logs/enum34_recipe.log)|[True](./logs/enum34_build.log)|True|None|
...
|pygments|[True](./logs/pygments_recipe.log)|[True](./logs/pygments_build.log)|True|None|
|cryptography|[True](./logs/cryptography_recipe.log)|[True](./logs/cryptography_build.log)|True|None|
|setuptools-git|[True](./logs/setuptools-git_recipe.log)|[True](./logs/setuptools-git_build.log)|False|None|
|lxml|[True](./logs/lxml_recipe.log)|[True](./logs/lxml_build.log)|True|None|
|psycopg2|[True](./logs/psycopg2_recipe.log)|[False](./logs/psycopg2_build.log)|False|unclassified|
|jsonschema|[True](./logs/jsonschema_recipe.log)|[True](./logs/jsonschema_build.log)|True|None|
|sqlalchemy|[True](./logs/sqlalchemy_recipe.log)|[True](./logs/sqlalchemy_build.log)|True|None|
|pyopenssl|[True](./logs/pyopenssl_recipe.log)|[True](./logs/pyopenssl_build.log)|True|None|
...
|redis|[True](./logs/redis_recipe.log)|[True](./logs/redis_build.log)|True|None|
|werkzeug|[True](./logs/werkzeug_recipe.log)|[True](./logs/werkzeug_build.log)|True|None|
...
|pika|[True](./logs/pika_recipe.log)|[True](./logs/pika_build.log)|False|None|
...
|kombu|[True](./logs/kombu_recipe.log)|[False](./logs/kombu_build.log)|False|test failure: missing dependency|
|pillow|[True](./logs/pillow_recipe.log)|[True](./logs/pillow_build.log)|True|None|
|numpy|[True](./logs/numpy_recipe.log)|[True](./logs/numpy_build.log)|True|None|
|urllib3|[True](./logs/urllib3_recipe.log)|[True](./logs/urllib3_build.log)|False|None|
|sphinx|[True](./logs/sphinx_recipe.log)|[True](./logs/sphinx_build.log)|True|None|
|flask|[True](./logs/flask_recipe.log)|[True](./logs/flask_build.log)|True|None|
|mysql-python|[False](./logs/mysql-python_recipe.log)|[False](./logs/mysql-python_build.log)|False|No recipe available|
|flake8|[True](./logs/flake8_recipe.log)|[True](./logs/flake8_build.log)|False|None|
|carbon|[True](./logs/carbon_recipe.log)|[False](./logs/carbon_build.log)|False|unclassified|
...
|supervisor|[True](./logs/supervisor_recipe.log)|[False](./logs/supervisor_build.log)|False|test failure: other reasons|
...
|celery|[True](./logs/celery_recipe.log)|[False](./logs/celery_build.log)|False|No packages found in current linux-64 channels|
|mako|[True](./logs/mako_recipe.log)|[True](./logs/mako_build.log)|False|None|
|ipython|[True](./logs/ipython_recipe.log)|[True](./logs/ipython_build.log)|True|None|
|wheel|[True](./logs/wheel_recipe.log)|[True](./logs/wheel_build.log)|False|None|
|zope.interface|[True](./logs/zope.interface_recipe.log)|[True](./logs/zope.interface_build.log)|False|None|
|pytest|[True](./logs/pytest_recipe.log)|[True](./logs/pytest_build.log)|True|None|
|billiard|[True](./logs/billiard_recipe.log)|[True](./logs/billiard_build.log)|False|None|
...
|blessings|[True](./logs/blessings_recipe.log)|[True](./logs/blessings_build.log)|False|None|
|pycurl|[True](./logs/pycurl_recipe.log)|[True](./logs/pycurl_build.log)|True|None|
|twisted|[True](./logs/twisted_recipe.log)|[False](./logs/twisted_build.log)|False|test failure: missing dependency|
...
|oauthlib|[True](./logs/oauthlib_recipe.log)|[True](./logs/oauthlib_build.log)|False|None|
|webob|[True](./logs/webob_recipe.log)|[True](./logs/webob_build.log)|False|None|
|alembic|[True](./logs/alembic_recipe.log)|[False](./logs/alembic_build.log)|False|test failure: missing dependency|
|paste|[True](./logs/paste_recipe.log)|[True](./logs/paste_build.log)|False|None|
...
|zc.buildout|[True](./logs/zc.buildout_recipe.log)|[True](./logs/zc.buildout_build.log)|False|None|
...
|raven|[True](./logs/raven_recipe.log)|[False](./logs/raven_build.log)|False|invalid syntax|
...
|requests-oauthlib|[True](./logs/requests-oauthlib_recipe.log)|[True](./logs/requests-oauthlib_build.log)|False|None|
...
|pycadf|[True](./logs/pycadf_recipe.log)|[False](./logs/pycadf_build.log)|False|missing build dependency|
|python-daemon|[True](./logs/python-daemon_recipe.log)|[True](./logs/python-daemon_build.log)|False|None|
|ndg-httpsclient|[True](./logs/ndg-httpsclient_recipe.log)|[True](./logs/ndg-httpsclient_build.log)|False|None|
|newrelic|[True](./logs/newrelic_recipe.log)|[False](./logs/newrelic_build.log)|False|test failure: other reasons|
|beautifulsoup|[True](./logs/beautifulsoup_recipe.log)|[False](./logs/beautifulsoup_build.log)|False|test failure: missing dependency|
|tempest-lib|[True](./logs/tempest-lib_recipe.log)|[False](./logs/tempest-lib_build.log)|False|missing build dependency|
|django-extensions|[True](./logs/django-extensions_recipe.log)|[False](./logs/django-extensions_build.log)|False|test failure: missing dependency|
...
|oslo.messaging|[True](./logs/oslo.messaging_recipe.log)|[False](./logs/oslo.messaging_build.log)|False|missing build dependency|
|unidecode|[True](./logs/unidecode_recipe.log)|[True](./logs/unidecode_build.log)|False|None|
|uwsgi|[True](./logs/uwsgi_recipe.log)|[False](./logs/uwsgi_build.log)|False|test failure: missing dependency|
|gitpython|[True](./logs/gitpython_recipe.log)|[False](./logs/gitpython_build.log)|False|test failure: missing dependency|
|django_compressor|[True](./logs/django_compressor_recipe.log)|[False](./logs/django_compressor_build.log)|False|No packages found in current linux-64 channels|
...
|smmap|[True](./logs/smmap_recipe.log)|[True](./logs/smmap_build.log)|False|None|
|pystache|[True](./logs/pystache_recipe.log)|[False](./logs/pystache_build.log)|False|test failure: other reasons|
|pymysql|[True](./logs/pymysql_recipe.log)|[False](./logs/pymysql_build.log)|False|test failure: missing dependency|
|xmltodict|[True](./logs/xmltodict_recipe.log)|[True](./logs/xmltodict_build.log)|False|None|
|webtest|[True](./logs/webtest_recipe.log)|[False](./logs/webtest_build.log)|False|No packages found in current linux-64 channels|
|gitdb|[True](./logs/gitdb_recipe.log)|[True](./logs/gitdb_build.log)|False|None|
|tempita|[True](./logs/tempita_recipe.log)|[True](./logs/tempita_build.log)|False|None|
|django-debug-toolbar|[True](./logs/django-debug-toolbar_recipe.log)|[False](./logs/django-debug-toolbar_build.log)|False|test failure: other reasons|
|trollius|[True](./logs/trollius_recipe.log)|[True](./logs/trollius_build.log)|False|None|
|nltk|[True](./logs/nltk_recipe.log)|[True](./logs/nltk_build.log)|True|None|
|diamond|[True](./logs/diamond_recipe.log)|[False](./logs/diamond_build.log)|False|unclassified|
|keystonemiddleware|[True](./logs/keystonemiddleware_recipe.log)|[False](./logs/keystonemiddleware_build.log)|False|missing build dependency|
|oslo.db|[True](./logs/oslo.db_recipe.log)|[False](./logs/oslo.db_build.log)|False|missing build dependency|
|oslo.rootwrap|[True](./logs/oslo.rootwrap_recipe.log)|[False](./logs/oslo.rootwrap_build.log)|False|missing build dependency|
...
|kazoo|[True](./logs/kazoo_recipe.log)|[True](./logs/kazoo_build.log)|False|None|
...
|oslo.middleware|[True](./logs/oslo.middleware_recipe.log)|[False](./logs/oslo.middleware_build.log)|False|missing build dependency|
|wtforms|[True](./logs/wtforms_recipe.log)|[True](./logs/wtforms_build.log)|False|None|
|helper|[True](./logs/helper_recipe.log)|[True](./logs/helper_build.log)|False|None|
...
|routes|[True](./logs/routes_recipe.log)|[True](./logs/routes_build.log)|False|None|
|dnspython|[True](./logs/dnspython_recipe.log)|[False](./logs/dnspython_build.log)|False|test failure: missing dependency|
...
|oslosphinx|[True](./logs/oslosphinx_recipe.log)|[False](./logs/oslosphinx_build.log)|False|missing build dependency|
...
|mozversion|[True](./logs/mozversion_recipe.log)|[False](./logs/mozversion_build.log)|False|No packages found in current linux-64 channels|
|ply|[True](./logs/ply_recipe.log)|[True](./logs/ply_build.log)|True|None|
...
|xlrd|[True](./logs/xlrd_recipe.log)|[True](./logs/xlrd_build.log)|True|None|
|python-magic|[True](./logs/python-magic_recipe.log)|[True](./logs/python-magic_build.log)|False|None|
|django-nose|[True](./logs/django-nose_recipe.log)|[False](./logs/django-nose_build.log)|False|test failure: other reasons|
...
|versiontools|[True](./logs/versiontools_recipe.log)|[True](./logs/versiontools_build.log)|False|None|
|treeherder-client|[True](./logs/treeherder-client_recipe.log)|[True](./logs/treeherder-client_build.log)|False|None|
|flask-script|[True](./logs/flask-script_recipe.log)|[True](./logs/flask-script_build.log)|False|None|
|django-celery|[True](./logs/django-celery_recipe.log)|[False](./logs/django-celery_build.log)|False|No packages found in current linux-64 channels|
...
|oslotest|[True](./logs/oslotest_recipe.log)|[False](./logs/oslotest_build.log)|False|missing build dependency|
|kairos|[True](./logs/kairos_recipe.log)|[False](./logs/kairos_build.log)|False|No packages found in current linux-64 channels|
|sh|[True](./logs/sh_recipe.log)|[True](./logs/sh_build.log)|False|None|
|flask-wtf|[True](./logs/flask-wtf_recipe.log)|[True](./logs/flask-wtf_build.log)|False|None|
|marionette_driver|[True](./logs/marionette_driver_recipe.log)|[False](./logs/marionette_driver_build.log)|False|No packages found in current linux-64 channels|
|keyring|[True](./logs/keyring_recipe.log)|[False](./logs/keyring_build.log)|False|No packages found in current linux-64 channels|
|chardet|[True](./logs/chardet_recipe.log)|[True](./logs/chardet_build.log)|False|None|
|shapely|[True](./logs/shapely_recipe.log)|[False](./logs/shapely_build.log)|False|test failure: other reasons|
|mox3|[True](./logs/mox3_recipe.log)|[False](./logs/mox3_build.log)|False|missing build dependency|
|qds_sdk|[True](./logs/qds_sdk_recipe.log)|[True](./logs/qds_sdk_build.log)|False|None|
|m2crypto|[True](./logs/m2crypto_recipe.log)|[False](./logs/m2crypto_build.log)|False|unclassified|
...
|httpretty|[True](./logs/httpretty_recipe.log)|[True](./logs/httpretty_build.log)|False|None|
|websockify|[False](./logs/websockify_recipe.log)|[False](./logs/websockify_build.log)|False|No recipe available|
|aioeventlet|[True](./logs/aioeventlet_recipe.log)|[False](./logs/aioeventlet_build.log)|False|No packages found in current linux-64 channels|
|execnet|[True](./logs/execnet_recipe.log)|[False](./logs/execnet_build.log)|False|missing build dependency|
|nosexcover|[True](./logs/nosexcover_recipe.log)|[True](./logs/nosexcover_build.log)|False|None|
|factory_boy|[True](./logs/factory_boy_recipe.log)|[False](./logs/factory_boy_build.log)|False|test failure: missing dependency|
|hiredis|[True](./logs/hiredis_recipe.log)|[True](./logs/hiredis_build.log)|False|None|
|pyjwt|[True](./logs/pyjwt_recipe.log)|[False](./logs/pyjwt_build.log)|False|test failure: other reasons|
|glob2|[True](./logs/glob2_recipe.log)|[True](./logs/glob2_build.log)|False|None|
|responses|[True](./logs/responses_recipe.log)|[True](./logs/responses_build.log)|False|None|
|testfixtures|[False](./logs/testfixtures_recipe.log)|[False](./logs/testfixtures_build.log)|False|No recipe available|
|virtualenvwrapper|[True](./logs/virtualenvwrapper_recipe.log)|[False](./logs/virtualenvwrapper_build.log)|False|missing build dependency|
|django-filter|[True](./logs/django-filter_recipe.log)|[False](./logs/django-filter_build.log)|False|test failure: missing dependency|
|ipdb|[True](./logs/ipdb_recipe.log)|[False](./logs/ipdb_build.log)|False|test failure: other reasons|
...
|pyserial|[True](./logs/pyserial_recipe.log)|[False](./logs/pyserial_build.log)|False|test failure: missing dependency|
|tablib|[True](./logs/tablib_recipe.log)|[False](./logs/tablib_build.log)|False|test failure: other reasons|
|flask-restful|[True](./logs/flask-restful_recipe.log)|[True](./logs/flask-restful_build.log)|False|None|
|python-instagram|[True](./logs/python-instagram_recipe.log)|[True](./logs/python-instagram_build.log)|False|None|
|behave|[True](./logs/behave_recipe.log)|[True](./logs/behave_build.log)|False|None|
...
|oslo.vmware|[True](./logs/oslo.vmware_recipe.log)|[False](./logs/oslo.vmware_build.log)|False|missing build dependency|
|importlib|[True](./logs/importlib_recipe.log)|[True](./logs/importlib_build.log)|False|None|
|dogpile.cache|[True](./logs/dogpile.cache_recipe.log)|[True](./logs/dogpile.cache_build.log)|False|None|
|parse_type|[True](./logs/parse_type_recipe.log)|[False](./logs/parse_type_build.log)|False|No packages found in current linux-64 channels|
|rfc3986|[True](./logs/rfc3986_recipe.log)|[True](./logs/rfc3986_build.log)|False|None|
|flexget|[True](./logs/flexget_recipe.log)|[False](./logs/flexget_build.log)|False|test failure: missing dependency|
|python-ldap|[True](./logs/python-ldap_recipe.log)|[False](./logs/python-ldap_build.log)|False|unclassified|
|regex|[True](./logs/regex_recipe.log)|[True](./logs/regex_build.log)|False|None|
|pytest-xdist|[True](./logs/pytest-xdist_recipe.log)|[False](./logs/pytest-xdist_build.log)|False|missing build dependency|
...
|mrjob|[True](./logs/mrjob_recipe.log)|[True](./logs/mrjob_build.log)|False|None|
|s3cmd|[True](./logs/s3cmd_recipe.log)|[False](./logs/s3cmd_build.log)|False|test failure: missing dependency|
...
|taskflow|[True](./logs/taskflow_recipe.log)|[False](./logs/taskflow_build.log)|False|missing build dependency|
|pathlib|[True](./logs/pathlib_recipe.log)|[True](./logs/pathlib_build.log)|False|None|
|xlwt|[True](./logs/xlwt_recipe.log)|[True](./logs/xlwt_build.log)|True|None|
|teamcity-messages|[True](./logs/teamcity-messages_recipe.log)|[True](./logs/teamcity-messages_build.log)|False|None|
|watchdog|[True](./logs/watchdog_recipe.log)|[True](./logs/watchdog_build.log)|False|None|
|django-cors-headers|[True](./logs/django-cors-headers_recipe.log)|[True](./logs/django-cors-headers_build.log)|False|None|
|dogpile.core|[True](./logs/dogpile.core_recipe.log)|[True](./logs/dogpile.core_build.log)|False|None|
|iptools|[True](./logs/iptools_recipe.log)|[True](./logs/iptools_build.log)|False|None|
...
|repoze.who|[True](./logs/repoze.who_recipe.log)|[False](./logs/repoze.who_build.log)|False|No packages found in current linux-64 channels|
|cassandra-driver|[True](./logs/cassandra-driver_recipe.log)|[True](./logs/cassandra-driver_build.log)|False|None|
|flufl.enum|[True](./logs/flufl.enum_recipe.log)|[True](./logs/flufl.enum_build.log)|False|None|
|python-ceilometerclient|[True](./logs/python-ceilometerclient_recipe.log)|[False](./logs/python-ceilometerclient_build.log)|False|missing build dependency|
|python-barbicanclient|[True](./logs/python-barbicanclient_recipe.log)|[False](./logs/python-barbicanclient_build.log)|False|missing build dependency|
|python-saharaclient|[True](./logs/python-saharaclient_recipe.log)|[False](./logs/python-saharaclient_build.log)|False|missing build dependency|
|openpyxl|[True](./logs/openpyxl_recipe.log)|[True](./logs/openpyxl_build.log)|True|None|
|pyscss|[True](./logs/pyscss_recipe.log)|[False](./logs/pyscss_build.log)|False|test failure: missing dependency|
|django-storages|[True](./logs/django-storages_recipe.log)|[False](./logs/django-storages_build.log)|False|test failure: missing dependency|
|django-mptt|[True](./logs/django-mptt_recipe.log)|[True](./logs/django-mptt_build.log)|False|None|
|oslo.policy|[True](./logs/oslo.policy_recipe.log)|[False](./logs/oslo.policy_build.log)|False|missing build dependency|
|python-openstackclient|[True](./logs/python-openstackclient_recipe.log)|[False](./logs/python-openstackclient_build.log)|False|missing build dependency|
|pyramid|[False](./logs/pyramid_recipe.log)|[False](./logs/pyramid_build.log)|False|No recipe available|
...
|kafka-python|[True](./logs/kafka-python_recipe.log)|[True](./logs/kafka-python_build.log)|False|None|
...
|whoosh|[True](./logs/whoosh_recipe.log)|[True](./logs/whoosh_build.log)|False|None|
|apscheduler|[True](./logs/apscheduler_recipe.log)|[True](./logs/apscheduler_build.log)|False|None|
|simplegeneric|[True](./logs/simplegeneric_recipe.log)|[True](./logs/simplegeneric_build.log)|False|None|
|mongoengine|[True](./logs/mongoengine_recipe.log)|[True](./logs/mongoengine_build.log)|False|None|
...
|pysaml2|[True](./logs/pysaml2_recipe.log)|[False](./logs/pysaml2_build.log)|False|No packages found in current linux-64 channels|
...
|wsme|[True](./logs/wsme_recipe.log)|[False](./logs/wsme_build.log)|False|missing build dependency|
...
|unittest-xml-reporting|[False](./logs/unittest-xml-reporting_recipe.log)|[False](./logs/unittest-xml-reporting_build.log)|False|No recipe available|
|argh|[True](./logs/argh_recipe.log)|[True](./logs/argh_build.log)|False|None|
|ansicolors|[True](./logs/ansicolors_recipe.log)|[False](./logs/ansicolors_build.log)|False|test failure: missing dependency|
|user-agents|[True](./logs/user-agents_recipe.log)|[True](./logs/user-agents_build.log)|False|None|
|osprofiler|[True](./logs/osprofiler_recipe.log)|[False](./logs/osprofiler_build.log)|False|missing build dependency|
|glance_store|[True](./logs/glance_store_recipe.log)|[False](./logs/glance_store_build.log)|False|missing build dependency|
|cliff-tablib|[True](./logs/cliff-tablib_recipe.log)|[False](./logs/cliff-tablib_build.log)|False|No packages found in current linux-64 channels|
|cx_oracle|[False](./logs/cx_oracle_recipe.log)|[False](./logs/cx_oracle_build.log)|False|No recipe available|
|maxminddb|[True](./logs/maxminddb_recipe.log)|[True](./logs/maxminddb_build.log)|False|None|
...
|libvirt-python|[True](./logs/libvirt-python_recipe.log)|[False](./logs/libvirt-python_build.log)|False|unclassified|
|cssutils|[True](./logs/cssutils_recipe.log)|[True](./logs/cssutils_build.log)|False|None|
|geoip2|[True](./logs/geoip2_recipe.log)|[True](./logs/geoip2_build.log)|False|None|
|argcomplete|[True](./logs/argcomplete_recipe.log)|[True](./logs/argcomplete_build.log)|True|None|
|rtslib-fb|[True](./logs/rtslib-fb_recipe.log)|[True](./logs/rtslib-fb_build.log)|False|None|
|venusian|[True](./logs/venusian_recipe.log)|[False](./logs/venusian_build.log)|False|No packages found in current linux-64 channels|
|bleach|[True](./logs/bleach_recipe.log)|[True](./logs/bleach_build.log)|False|None|
|python-troveclient|[True](./logs/python-troveclient_recipe.log)|[False](./logs/python-troveclient_build.log)|False|missing build dependency|
|cm-api|[True](./logs/cm-api_recipe.log)|[False](./logs/cm-api_build.log)|False|No packages found in current linux-64 channels|
|django-model-utils|[True](./logs/django-model-utils_recipe.log)|[True](./logs/django-model-utils_build.log)|False|None|
|twilio|[True](./logs/twilio_recipe.log)|[False](./logs/twilio_build.log)|False|No packages found in current linux-64 channels|
|jsonfield|[True](./logs/jsonfield_recipe.log)|[True](./logs/jsonfield_build.log)|False|None|
...
|django-redis|[True](./logs/django-redis_recipe.log)|[False](./logs/django-redis_build.log)|False|No packages found in current linux-64 channels|
...
|django-pyscss|[True](./logs/django-pyscss_recipe.log)|[False](./logs/django-pyscss_build.log)|False|No packages found in current linux-64 channels|
|zope.component|[False](./logs/zope.component_recipe.log)|[False](./logs/zope.component_build.log)|False|No recipe available|
|os-client-config|[True](./logs/os-client-config_recipe.log)|[False](./logs/os-client-config_build.log)|False|missing build dependency|
...
|pylibmc|[True](./logs/pylibmc_recipe.log)|[False](./logs/pylibmc_build.log)|False|unclassified|
...
|django-crispy-forms|[True](./logs/django-crispy-forms_recipe.log)|[False](./logs/django-crispy-forms_build.log)|False|No packages found in current linux-64 channels|
|flask-mail|[True](./logs/flask-mail_recipe.log)|[True](./logs/flask-mail_build.log)|False|None|
|robotframework|[True](./logs/robotframework_recipe.log)|[False](./logs/robotframework_build.log)|False|test failure: missing dependency|
...
|wand|[True](./logs/wand_recipe.log)|[True](./logs/wand_build.log)|False|None|
|django_openstack_auth|[True](./logs/django_openstack_auth_recipe.log)|[False](./logs/django_openstack_auth_build.log)|False|missing build dependency|
|jenkinsapi|[True](./logs/jenkinsapi_recipe.log)|[True](./logs/jenkinsapi_build.log)|False|None|
|singledispatch|[True](./logs/singledispatch_recipe.log)|[True](./logs/singledispatch_build.log)|False|None|
|invoke|[True](./logs/invoke_recipe.log)|[False](./logs/invoke_build.log)|False|invalid syntax|
|sqlobject|[False](./logs/sqlobject_recipe.log)|[False](./logs/sqlobject_build.log)|False|No recipe available|
|unicodecsv|[True](./logs/unicodecsv_recipe.log)|[True](./logs/unicodecsv_build.log)|True|None|
...
|mistune|[True](./logs/mistune_recipe.log)|[True](./logs/mistune_build.log)|True|None|
...
|multiprocessing|[True](./logs/multiprocessing_recipe.log)|[False](./logs/multiprocessing_build.log)|False|test failure: missing dependency|
|django-reversion|[True](./logs/django-reversion_recipe.log)|[False](./logs/django-reversion_build.log)|False|test failure: missing dependency|
|shortuuid|[True](./logs/shortuuid_recipe.log)|[True](./logs/shortuuid_build.log)|False|None|
...
|debtcollector|[True](./logs/debtcollector_recipe.log)|[False](./logs/debtcollector_build.log)|False|missing build dependency|
|astropy|[True](./logs/astropy_recipe.log)|[True](./logs/astropy_build.log)|True|None|
|setuptools_subversion|[True](./logs/setuptools_subversion_recipe.log)|[True](./logs/setuptools_subversion_build.log)|False|None|
|flask-migrate|[True](./logs/flask-migrate_recipe.log)|[False](./logs/flask-migrate_build.log)|False|No packages found in current linux-64 channels|
|scrapy|[True](./logs/scrapy_recipe.log)|[False](./logs/scrapy_build.log)|False|test failure: missing dependency|
|patsy|[True](./logs/patsy_recipe.log)|[True](./logs/patsy_build.log)|True|None|
|tabulate|[True](./logs/tabulate_recipe.log)|[True](./logs/tabulate_build.log)|False|None|
|gnureadline|[True](./logs/gnureadline_recipe.log)|[False](./logs/gnureadline_build.log)|False|unclassified|
...
|future|[True](./logs/future_recipe.log)|[False](./logs/future_build.log)|False|test failure: missing dependency|
|chameleon|[True](./logs/chameleon_recipe.log)|[True](./logs/chameleon_build.log)|False|None|
|django-taggit|[True](./logs/django-taggit_recipe.log)|[False](./logs/django-taggit_build.log)|False|test failure: missing dependency|
|beaker|[True](./logs/beaker_recipe.log)|[False](./logs/beaker_build.log)|False|No packages found in current linux-64 channels|
|elasticsearch-dsl|[True](./logs/elasticsearch-dsl_recipe.log)|[True](./logs/elasticsearch-dsl_build.log)|False|None|
|sqlalchemy-utils|[True](./logs/sqlalchemy-utils_recipe.log)|[False](./logs/sqlalchemy-utils_build.log)|False|No packages found in current linux-64 channels|
|twiceredis|[True](./logs/twiceredis_recipe.log)|[False](./logs/twiceredis_build.log)|False|missing build dependency|
|pecan|[True](./logs/pecan_recipe.log)|[False](./logs/pecan_build.log)|False|No packages found in current linux-64 channels|
|scikit-image|[True](./logs/scikit-image_recipe.log)|[True](./logs/scikit-image_build.log)|True|None|
...
|cache_requests|[True](./logs/cache_requests_recipe.log)|[False](./logs/cache_requests_build.log)|False|No packages found in current linux-64 channels|
|ipy|[True](./logs/ipy_recipe.log)|[False](./logs/ipy_build.log)|False|test failure: missing dependency|
|sorl-thumbnail|[True](./logs/sorl-thumbnail_recipe.log)|[False](./logs/sorl-thumbnail_build.log)|False|test failure: missing dependency|
|configparser|[True](./logs/configparser_recipe.log)|[True](./logs/configparser_build.log)|False|None|
|guess_language-spirit|[False](./logs/guess_language-spirit_recipe.log)|[False](./logs/guess_language-spirit_build.log)|False|No recipe available|
|blist|[True](./logs/blist_recipe.log)|[True](./logs/blist_build.log)|False|None|
|python-social-auth|[True](./logs/python-social-auth_recipe.log)|[False](./logs/python-social-auth_build.log)|False|No packages found in current linux-64 channels|
...
|oslo.versionedobjects|[True](./logs/oslo.versionedobjects_recipe.log)|[False](./logs/oslo.versionedobjects_build.log)|False|missing build dependency|
...
|pyodbc|[True](./logs/pyodbc_recipe.log)|[False](./logs/pyodbc_build.log)|False|unclassified|
|python-levenshtein|[True](./logs/python-levenshtein_recipe.log)|[True](./logs/python-levenshtein_build.log)|False|None|
|numpydoc|[True](./logs/numpydoc_recipe.log)|[False](./logs/numpydoc_build.log)|False|test failure: missing dependency|
|django-pipeline|[True](./logs/django-pipeline_recipe.log)|[False](./logs/django-pipeline_build.log)|False|test failure: missing dependency|
...
|django-haystack|[True](./logs/django-haystack_recipe.log)|[False](./logs/django-haystack_build.log)|False|test failure: other reasons|
...
|xlsxwriter|[True](./logs/xlsxwriter_recipe.log)|[True](./logs/xlsxwriter_build.log)|True|None|
|xstatic-jquery-ui|[True](./logs/xstatic-jquery-ui_recipe.log)|[False](./logs/xstatic-jquery-ui_build.log)|False|unclassified|
|xstatic|[True](./logs/xstatic_recipe.log)|[True](./logs/xstatic_build.log)|False|None|
|moto|[True](./logs/moto_recipe.log)|[True](./logs/moto_build.log)|False|None|
|avro|[True](./logs/avro_recipe.log)|[False](./logs/avro_build.log)|False|No packages found in current linux-64 channels|
|pypyodbc|[True](./logs/pypyodbc_recipe.log)|[False](./logs/pypyodbc_build.log)|False|test failure: other reasons|
|xstatic-bootstrap-scss|[True](./logs/xstatic-bootstrap-scss_recipe.log)|[True](./logs/xstatic-bootstrap-scss_build.log)|False|None|
|mkdocs|[False](./logs/mkdocs_recipe.log)|[False](./logs/mkdocs_build.log)|False|No recipe available|
...
|pypdf2|[True](./logs/pypdf2_recipe.log)|[False](./logs/pypdf2_build.log)|False|test failure: missing dependency|
