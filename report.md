...
|coverage|[True](./logs/coverage_recipe.log)|[False](./logs/coverage_build.log)|False|unclassified|
...
|psutil|[None](./logs/psutil_recipe.log)|[None](./logs/psutil_build.log)|True|None|
...
|carbon|[False](./logs/carbon_recipe.log)|[False](./logs/carbon_build.log)|False|No recipe available|
...
|itsdangerous|[None](./logs/itsdangerous_recipe.log)|[None](./logs/itsdangerous_build.log)|True|None|
...
|wheel|[True](./logs/wheel_recipe.log)|[False](./logs/wheel_build.log)|False|No packages found in current linux-64 channels|
|zope.interface|[True](./logs/zope.interface_recipe.log)|[False](./logs/zope.interface_build.log)|False|No packages found in current linux-64 channels|
...
|fabric|[True](./logs/fabric_recipe.log)|[False](./logs/fabric_build.log)|False|unclassified|
...
|twisted|[False](./logs/twisted_recipe.log)|[False](./logs/twisted_build.log)|False|No recipe available|
...
|paste|[True](./logs/paste_recipe.log)|[False](./logs/paste_build.log)|False|No packages found in current linux-64 channels|
...
|pastedeploy|[True](./logs/pastedeploy_recipe.log)|[True](./logs/pastedeploy_build.log)|False|None|
...
|mozcrash|[True](./logs/mozcrash_recipe.log)|[False](./logs/mozcrash_build.log)|False|unclassified|
...
|testrepository|[True](./logs/testrepository_recipe.log)|[False](./logs/testrepository_build.log)|False|invalid syntax|
...
|newrelic|[True](./logs/newrelic_recipe.log)|[False](./logs/newrelic_build.log)|False|unclassified|
...
|pystache|[True](./logs/pystache_recipe.log)|[False](./logs/pystache_build.log)|False|unclassified|
...
|discover|[True](./logs/discover_recipe.log)|[False](./logs/discover_build.log)|False|unclassified|
|kazoo|[True](./logs/kazoo_recipe.log)|[False](./logs/kazoo_build.log)|False|No packages found in current linux-64 channels|
...
|chardet|[True](./logs/chardet_recipe.log)|[False](./logs/chardet_build.log)|False|unclassified|
...
|pyjwt|[False](./logs/pyjwt_recipe.log)|[False](./logs/pyjwt_build.log)|False|No recipe available|
|glob2|[True](./logs/glob2_recipe.log)|[True](./logs/glob2_build.log)|False|None|
|responses|[True](./logs/responses_recipe.log)|[False](./logs/responses_build.log)|False|No packages found in current linux-64 channels|
...
|ipdb|[True](./logs/ipdb_recipe.log)|[False](./logs/ipdb_build.log)|False|unclassified|
...
|xattr|[True](./logs/xattr_recipe.log)|[False](./logs/xattr_build.log)|False|unclassified|
...
|oslo.policy|[False](./logs/oslo.policy_recipe.log)|[False](./logs/oslo.policy_build.log)|False|No recipe available|
...
|ansicolors|[True](./logs/ansicolors_recipe.log)|[True](./logs/ansicolors_build.log)|False|None|
...
|cssutils|[True](./logs/cssutils_recipe.log)|[False](./logs/cssutils_build.log)|False|unclassified|
...
|rtslib-fb|[True](./logs/rtslib-fb_recipe.log)|[False](./logs/rtslib-fb_build.log)|False|test failure: missing dependency|
...
|django-redis|[True](./logs/django-redis_recipe.log)|[False](./logs/django-redis_build.log)|False|test failure: missing dependency|
...
|django-pyscss|[True](./logs/django-pyscss_recipe.log)|[False](./logs/django-pyscss_build.log)|False|test failure: other reasons|
...
|flask-migrate|[True](./logs/flask-migrate_recipe.log)|[True](./logs/flask-migrate_build.log)|False|None|
|scrapy|[False](./logs/scrapy_recipe.log)|[False](./logs/scrapy_build.log)|False|No recipe available|
...
|future|[True](./logs/future_recipe.log)|[False](./logs/future_build.log)|False|unclassified|
...
|twiceredis|[True](./logs/twiceredis_recipe.log)|[True](./logs/twiceredis_build.log)|False|None|
...
|python-levenshtein|[True](./logs/python-levenshtein_recipe.log)|[False](./logs/python-levenshtein_build.log)|False|unclassified|
...
|mkdocs|[True](./logs/mkdocs_recipe.log)|[False](./logs/mkdocs_build.log)|False|No packages found in current linux-64 channels|
...
No recipe available: 34/240


No packages found in current linux-64 channels: 28/240


missing build dependency: 50/240


test failure: missing dependency: 19/240


test failure: other reasons: 8/240


invalid syntax: 4/240
